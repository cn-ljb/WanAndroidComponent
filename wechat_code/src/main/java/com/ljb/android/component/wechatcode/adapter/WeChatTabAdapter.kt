...
import com.ljb.android.component.wechatcode.view.fragment.WXArticleListFragment
 ...
 **/
class WeChatTabAdapter(private val data: List<WCodeTabBean.ListBean>, manager: FragmentManager) :

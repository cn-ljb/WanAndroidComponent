...
import com.ljb.android.component.chat.socket.notify.SocketNotificationChannel
...
class SocketService : Service() {
    ...
    override fun onCreate() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            SocketNotificationChannel.initChannel(this, BuildConfig.APP_ID)
            val icon = BitmapFactory.decodeResource(resources, R.mipmap.comm_icon_app)
            val notification = Notification.Builder(this)
                .setChannelId(BuildConfig.APPLICATION_ID)
                .setContentTitle("Socket Service 已启动")
